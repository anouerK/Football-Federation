...
class CategorieController extends AbstractController
{
    ...
    /**
     * @Route("/getcat", name="getcat")
     */
    public function getcat(CathegorieRepository $repository,NormalizerInterface $serializer,Request $request){
        //$marque=$this->getDoctrine()->getManager()->getRepository(Marques::class)->findAll();
        $marque=$request->query->get("id");
        $rep= $this->getDoctrine()->getRepository(Categorie::class);
      //  $marque=$rep->find($marque);
        $marque=$rep->findAll();
        $formatted=$serializer->serialize($marque,'json',['groups'=>'cat']);
    ...
    /**
     * @Route("/searchcat/{searchString}", name="searchcat")
     */
    public function searchcat($searchString,NormalizerInterface $serializerInterface ,Request $request)
    {
        //$serializer=new Serializer([new ObjectNormalizer()]);
        // $serializer = new Serializer([new ObjectNormalizer()]);
        ...
        $data = $serializerInterface->normalize($students,'json',['groups'=>'cat']);
