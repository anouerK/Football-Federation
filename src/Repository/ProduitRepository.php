...
class ProduitRepository extends ServiceEntityRepository
{
    ...
    public function filterprixc()
    {
        $query= $this->getEntityManager()->createQuery('select p from App\Entity\Produit p order by p.prix ');

        return $query->getResult();
    }

    public function filterprixd()
    {
        $query= $this->getEntityManager()->createQuery('select p from App\Entity\Produit p order by p.prix desc ');
