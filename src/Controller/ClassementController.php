...
class ClassementController extends AbstractController
{
    ...
    /**
     * @Route("/affclas", name="affclas")
     */
    public function affclas(Request $request,NormalizerInterface  $Normalizer,ClubRepository  $clubRepository): Response
    {
        $id = $request->get("id");
        //$result = $this->getDoctrine()->getRepository(classement::class);
        $result = $this->getDoctrine()->getRepository(Classement::class);
        ...
        foreach ( $resultt as $x) {
            ...
            $dataclub[] =
                [
                    ...
                    //'club' => $clubRepository->find($x->getid()),
                    'club' => $Normalizer->normalize($clubRepository->find($x->getid()),'json',['groups'=>'cl']),
        ...
        // $json=$Normalizer->normalize($dataclub,'json',['groups'=>'cl']);


        return new Response(json_encode($dataclub));
