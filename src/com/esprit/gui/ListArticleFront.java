 ...
 * @author ksaay
 */
public class ListArticleFront extends Form {
    public ListArticleFront(Form previous,Resources res)
    {
        super("List Articles");
  ...
  EncodedImage placeholder = EncodedImage.createFromImage(Image.createImage(mm * 6, mm * 8, 0), false);
        ...
        Container buttonss = BoxLayout.encloseX();
              ...
              Button delete = new Button();
                ...
                FontImage.setMaterialIcon(view, FontImage.MATERIAL_VIEW_AGENDA);
                
                buttonss.add(BorderLayout.center(view));
                 
              
                

 SpanLabel titretext = new SpanLabel(ev.getTitre());
    SpanLabel usertext = new SpanLabel("["+ev.getUser().getUsername()+"]");
...
titretext.getAllStyles().setFont(Font.createSystemFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_MEDIUM));
     ...
     new ViewArticleFront(this,ev).show();
